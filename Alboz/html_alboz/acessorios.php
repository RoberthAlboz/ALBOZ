...
<head>
    ...
    <style>
        ...
        /* Reset básico para ocupar a tela toda */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Configuração do Container dos Raios de Luz (Fundo) */
        ...
        /* Container Centralizado para o seu Conteúdo */
        .centro-tela {
            position: absolute;
            top: 50%;
            left: 50%;
...
<body>
    ...
    <!-- Área Centralizada para seu Texto/Comentário -->
    <div class="centro-tela">
        <h1>Ligne Sportive</h1>
        <p>Em breve, uma nova coleção de acessórios exclusivos.</p>
        <p>deu erro no fundo🫠</p>
    </div>

    <!-- SCRIPT PARA ATIVAR OS RAIOS DE LUZ -->
    <!-- Coloquei o código JS todo aqui dentro para não precisar de arquivo extra -->
    <script type="module">
